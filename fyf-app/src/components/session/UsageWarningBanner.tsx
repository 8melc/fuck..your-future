    ...
    >
      <div className="flex items-center gap-3 p-4">
        ...
        <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
          isCritical ? 'bg-fyf-coral' : 'bg-fyf-mint'
        }`}>
          <svg
            className={`w-5 h-5 ${
              isCritical ? 'text-fyf-noir' : 'text-fyf-noir'
            }`}
            fill="currentColor"
            viewBox="0 0 20 20"
          >
        ...
        <div className="flex-1">
          <h3 className={`font-semibold text-sm mb-1 ${
            isCritical ? 'text-fyf-coral' : 'text-fyf-mint'
          }`}>
            {isCritical ? 'FYF stoppt gleich!' : 'Zeitlimit-Warnung'}
          </h3>
          <p className="text-fyf-cream text-sm">
            {isCritical 
        ...
        >
          <svg
            className="w-5 h-5 text-fyf-steel"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
